...
class Command(BaseCommand):
    ...
    def handle(self,*args,**options):
        ...
        analyst.permissions.set(Permission.objects.filter(codename__in=["add_project","view_project","add_medicalimage","view_medicalimage","add_analysis","view_analysis"]))
        reviewer.permissions.set(Permission.objects.filter(codename__in=["view_project","view_medicalimage","view_analysis","add_review","view_review"]))
